...
class grafikPemprov extends Controller
{
    ...
    public function grafikPemprov(Request $request)
    {
        ...
        $perangkatDaerahs = PerangkatDaerah::where('kategori_informasi_id', 1)
            ->with([
        ...
        return view('content.laporan-analisis.grafik-pemprov', compact('labels', 'datasets', 'dariTahun', 'sampaiTahun'));
    }
}
