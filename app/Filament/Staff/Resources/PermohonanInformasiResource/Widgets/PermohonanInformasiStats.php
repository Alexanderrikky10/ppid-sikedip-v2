...
namespace App\Filament\Staff\Resources\PermohonanInformasiResource\Widgets;
...
class PermohonanInformasiStats extends BaseWidget
{
    ...
    private function baseQuery()
    {
        ...
        if (!$this->isValidStaff()) {
            return PermohonanInformasi::whereRaw('1 = 0');
        }

        // Filter WAJIB: hanya data OPD milik staff ini
        return PermohonanInformasi::where(
            'perangkat_daerah_id',
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make('Total Keseluruhan', $this->formatNumber($totalKeseluruhan))
                ->description('Semua permohonan informasi OPD: ' . $namaOPD)
                ->descriptionIcon('heroicon-m-archive-box')
                ->chart($this->chartTotal())
                ->color('primary'),

            // ── Stat 5: Sedang Diproses ───────────────────────────
