...
use App\Filament\Widgets\InformasiPemprovStats;
...
class InformasiPemprov extends Page implements HasForms, HasTable
{
    ...
    protected static string $view = 'filament.staff.pages.informasi.informasi-pemprov';
