...
class InformasiBumd extends Page implements HasForms, HasTable
{
    ...
    protected static string $view = 'filament.staff.pages.informasi.informasi-bumd';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                // Kolom 2: Perangkat Daerah / BUMD (Badge Biru)
