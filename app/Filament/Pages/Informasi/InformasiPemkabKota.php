...
use Illuminate\Database\Eloquent\Builder; // ✅ PENTING: Import ini wajib ada

class InformasiPemkabKota extends Page implements HasForms
{
        ...
        return $form
            ...
            ->schema([
                Forms\Components\Hidden::make('kategori_informasi_id')
                    ->default(2), // ID 2 untuk Pemkab/Kota
                        ...
                        Forms\Components\Section::make('Penanggung Jawab & Administrasi')
                            ->schema([
                                Forms\Components\TextInput::make('pj_penerbit_informasi')
                                    ...
                                    ->required()
                                    ->datalist(fn() => Informasi::where('kategori_informasi_id', 2)->pluck('pj_penerbit_informasi')->unique()->toArray()),

                                Forms\Components\TextInput::make('pejabat_pj')
                                    ->label('Pejabat Penanggung Jawab')
                                    ->required()
                                    ->datalist(fn() => Informasi::where('kategori_informasi_id', 2)->pluck('pejabat_pj')->unique()->toArray()),
    ...
    public function create(): void
    {
        ...
        $data['kategori_informasi_id'] = 2; // Pastikan ID 2
