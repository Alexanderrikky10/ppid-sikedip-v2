            ...
            <div class="flex flex-col xl:flex-row xl:items-end justify-between gap-8 mb-12">
                <div class="space-y-4">
                    ...
                    <h1 class="text-5xl font-black text-white leading-tight tracking-tight">
                        Statistik <span class="text-green-400">Pemkab/Pemkot</span>
                    </h1>
                ...
                <div class="bg-white/10 backdrop-blur-lg p-6 rounded-[2.5rem] shadow-2xl border border-white/20">
                    <form action="{{ route('grafik-pemkabkota') }}" method="GET" class="flex flex-wrap items-center gap-4">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-600 font-bold uppercase tracking-widest opacity-70"> Pemkab/Pemkot
                            </p>
                        </div>
                    </div>
