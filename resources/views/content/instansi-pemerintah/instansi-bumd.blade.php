    ...
    <div class="bg-gradient-to-r from-green-900 to-green-800 pt-32 pb-12 text-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="flex flex-col items-center justify-center text-center">
                ...
                {{-- JUDUL HALAMAN BUMD --}}
                <h1 class="text-3xl md:text-4xl font-bold mb-3 drop-shadow-md">Badan Usaha Milik Daerah (BUMD)</h1>
                <p class="text-green-100 opacity-90 text-sm md:text-base max-w-2xl mx-auto font-light leading-relaxed">
                    Daftar Badan Usaha Milik Daerah yang beroperasi di wilayah Provinsi Kalimantan Barat.
                </p>
            </div>
        </div>
    </div>
    ...
    <section class="py-12 bg-gray-50 min-h-screen" x-data="{ search: '{{ request('search') }}', activeTab: 'utama' }">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                {{-- LOOPING DATA ($BumdUtama dari Controller) --}}
                @forelse($BumdUtama as $opd)

                    {{-- PHP LOGIC: GAMBAR DARI MINIO --}}
                    @php
                        // 1. Logic Filter Tab (Cek Parent)
                        ...
                        if (!empty($opd->images)) {
                            try {
                                // Generate Signed URL MinIO (Valid 60 menit)
                    ...
                    {{-- CARD BUMD --}}
                    <a href="{{ route('daftar-informasi-bumd.list', ['slug' => $opd->slug]) }}"
                        ...
                        {{-- Logic Filter Client Side (AlpineJS) --}}
                        ...
                        {{-- LOGO CONTAINER (GAMBAR DITAMPILKAN DISINI) --}}
