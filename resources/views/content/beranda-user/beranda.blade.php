...
@section('content')
    ...
    {{-- =======================================================================
    BAGIAN 1: HERO SLIDER (Desain Gambar 1)
    ======================================================================= --}}
    <section x-data="{ 
            activeSlide: 0, 
            slides: [
        ...
        <div class="relative z-10 w-full max-w-5xl px-4 text-center mt-16">
            ...
            <div class="relative max-w-2xl mx-auto group">
                ...
                <input type="text"
                    class="block w-full pl-12 pr-6 py-4 rounded-full text-gray-900 bg-white/95 border-0 shadow-xl focus:ring-4 focus:ring-blue-500/30 text-lg placeholder-gray-500 transition-all hover:bg-white"
    ...
    {{-- =======================================================================
    BAGIAN 2: LAYANAN INFORMASI & KARTU (Desain Gambar 2)
    ======================================================================= --}}
    <section id="layanan-section" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                ...
                {{-- KARTU KIRI (Besar Biru) --}}
                <div
                    class="relative overflow-hidden rounded-3xl bg-blue-600 text-white shadow-2xl lg:col-span-1 min-h-[400px] flex flex-col justify-between p-8 sm:p-10 group">

                    {{-- Decorative Background (Abstract / Newspaper) --}}
                    ...
                    <div class="relative z-10 mt-auto">
                        <a href="#"
                            class="inline-flex items-center justify-center w-full px-6 py-4 text-base font-bold text-blue-700 bg-white rounded-xl shadow-lg hover:bg-blue-50 transition-all duration-300 group-hover:translate-y-[-2px]">
                ...
                <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {{-- Kartu 1: Permohonan --}}
                    <div
                        class="bg-white rounded-3xl p-6 shadow-md border border-blue-100 hover:shadow-xl hover:border-blue-300 transition-all duration-300 flex flex-col h-full group">
                        <div class="flex items-start justify-between mb-4">
                            <div
                                class="w-12 h-12 bg-blue-600 rounded-xl flex items-center justify-center text-white text-xl shadow-lg shadow-blue-600/30 group-hover:scale-110 transition-transform">
                                <i class="far fa-file-alt"></i>
                            </div>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Permohonan Informasi</h3>
                        <div class="w-10 h-1 bg-blue-600 rounded-full mb-3"></div>
                        ...
                        <a href="#"
                            class="text-blue-600 font-semibold text-sm flex items-center group-hover:text-blue-800 transition-colors">
                            Ajukan Permohonan <i
